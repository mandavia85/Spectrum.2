...
// Plain static filename on purpose — see api/entity.js for why dynamic
// bracket routes ([table].js) were replaced with query-param routing.
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error(`[api/entities?table=${table}]`, err);
